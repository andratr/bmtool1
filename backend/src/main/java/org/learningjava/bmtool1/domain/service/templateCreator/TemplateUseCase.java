...
import org.learningjava.bmtool1.domain.service.templateCreator.PlsqlToJavaTemplateMapper;

import java.nio.file.*;
import java.util.List;

public class TemplateUseCase {
    private final PlsqlBlockExtractor extractor = new PlsqlBlockExtractor();
    private final PlsqlToJavaTemplateMapper mapper = new PlsqlToJavaTemplateMapper();
