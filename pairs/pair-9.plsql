DECLARE
    ...
    v_is_active       CHAR(1);
    v_proc_name       VARCHAR2(200) := 'LIM_FORMS2SDPOP_DEFAULTED';
    ...
    IF v_is_active = 'Y' THEN
        ...
        BEGIN
            ...
            SELECT v_sys_identifier,
                   ...
                   NULL,                       -- crm value
                   'forb_meas_start_date_2 set to null when forb_meas_2 is not available',
                   NULL                        -- record_id
            FROM raw_limit rl
        ...
        -- Default forb_meas_start_date_2 to NULL
        BEGIN
            UPDATE raw_limit rl
